...
이 문서는 Chrome 웹 스토어 개발자 대시보드의 각 칸에 그대로 옮겨 적을 수 있도록 작성했습니다. 현재 배포 대상 버전은 `1.15.3`입니다.
...
5. `dist/weverse-instagram-korean-overlay-v1.15.3-chrome-web-store.zip` 업로드
